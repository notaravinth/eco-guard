  ...
  return (
    <div className="min-h-screen bg-[#060d06] text-white overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 border-b border-white/5 bg-[#060d06]/80 backdrop-blur-md">
        ...
        <Link
          to="/login"
          className="bg-green-500 hover:bg-green-400 text-black font-semibold text-sm px-5 py-2 rounded-full transition-colors"
        >
          Sign In
        </Link>
      </nav>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 pt-16 pb-10">
        <div className="flex items-center gap-2 bg-[#111811] border border-white/10 rounded-full px-3 py-1 mb-8">
          <span className="bg-green-500 text-black text-xs font-bold px-2 py-0.5 rounded-full">NEW</span>
          <span className="text-sm text-gray-300">AI species detection just launched</span>
        </div>
      ...
      {/* Cards */}
      <div className="relative z-10 flex gap-4 px-8 pb-24 max-w-5xl mx-auto">
        <div className="flex-[2] bg-[#d1d5d1] rounded-2xl h-56 flex flex-col items-center justify-center gap-2">
          <span className="text-3xl">📸</span>
          <span className="text-gray-600 text-lg font-medium">upload the image / take photo</span>
          <span className="text-gray-400 text-sm">JPG, PNG, HEIC supported</span>
        </div>
        <div className="flex-[0.7] bg-[#d1d5d1] rounded-2xl h-56 flex flex-col items-center justify-center gap-2">
          <span className="text-3xl">📍</span>
          <span className="text-gray-600 text-lg font-medium">location</span>
          <span className="text-gray-400 text-sm">Auto or manual</span>
        </div>
      </div>
      ...
      <section id="how" className="relative z-10 px-8 py-24 max-w-5xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl font-bold text-white mt-2">How EcoGuard Works</h2>
          <p className="text-gray-400 mt-3 max-w-lg mx-auto">Three simple steps to protect ecosystems from invasive species — powered by AI and satellite data.</p>
        </div>
      ...
      {/* Species */}
      <section id="species" className="relative z-10 px-8 py-24 max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <span className="text-green-500 text-sm font-semibold uppercase tracking-widest">Database</span>
          <h2 className="text-4xl font-bold text-white mt-2">Tracked Invasive Species</h2>
          <p className="text-gray-400 mt-3 max-w-lg mx-auto">Our model is trained to recognize the most damaging invasive plants threatening local ecosystems.</p>
        </div>
      ...
      {/* Community */}
      <section id="community" className="relative z-10 bg-[#0a110a] border-y border-white/5 px-8 py-24">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <span className="text-green-500 text-sm font-semibold uppercase tracking-widest">Community</span>
            <h2 className="text-4xl font-bold text-white mt-2 mb-4">Citizens powering ecological defence</h2>
      ...
      <section className="relative z-10 px-8 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Ready to protect your ecosystem?</h2>
      ...
      {/* Footer */}
      <footer id="about" className="relative z-10 border-t border-white/5 px-8 py-10">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600 text-sm ml-2">Invasive Species Prediction Platform</span>
          </div>
          ...
          <p className="text-gray-600 text-xs">© 2026 EcoGuard. Built for EcoTech Track.</p>
        </div>
      </footer>
