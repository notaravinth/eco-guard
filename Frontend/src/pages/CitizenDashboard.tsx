    ...
    <div className="min-h-screen bg-[#060d06] text-white">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 border-b border-white/5 bg-[#060d06]/80 backdrop-blur-md">
        ...
        <div className="flex items-center gap-4">
          <span className="text-gray-400 text-sm">👤 {profile?.full_name ?? 'Citizen'}</span>
          <button
      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        {/* Report button */}
        <div className="bg-[#0d150d] border border-white/10 rounded-2xl p-8 mb-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
          ...
          <button className="bg-green-500 hover:bg-green-400 text-black font-semibold px-6 py-3 rounded-full transition-colors whitespace-nowrap">
            📸 Report a Sighting
          </button>
        </div>
