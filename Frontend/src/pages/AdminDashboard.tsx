    ...
    <div className="min-h-screen bg-[#060d06] text-white">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-4 md:px-8 py-3 md:py-4 border-b border-white/5 bg-[#060d06]/80 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="bg-green-500/20 text-green-400 text-xs font-medium px-2 py-0.5 rounded-full ml-1">
            Admin
          </span>
        </div>
        <div className="flex items-center gap-3">
          <span className="hidden sm:block text-gray-400 text-sm truncate max-w-[120px]">
            🛡️ {profile?.full_name ?? "Admin"}
          </span>
          <button
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <div className="mb-10">
          ...
          <p className="text-gray-400">
            Monitor sightings, users, and escalate verified cluster reports.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div
              key={label}
              className="bg-[#0d150d] border border-white/10 rounded-xl p-4 text-center"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-[#0d150d] border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-gray-500 text-sm">
              Haversine clustering coming soon.
            </p>
          </div>
          <div className="bg-[#0d150d] border border-white/10 rounded-2xl p-6">
